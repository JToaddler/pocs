...
public class DemoWorldAPI {
	...
	final static Logger LOGGER = LoggerFactory.getLogger(DemoWorldAPI.class);
	...
	@RequestMapping(path = "/getAllCountry", produces = {
			MediaType.APPLICATION_JSON_VALUE }, method = RequestMethod.GET)
	private @ResponseBody Response getAllCountry() {
	...
	private static String getEC2MetaData() {
		...
		try {
			...
			LOGGER.error("getEC2MetaData", exe);
			return "Failed";
		}
